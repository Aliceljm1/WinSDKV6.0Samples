...
//
class COverlayCallback : public IDDrawExclModeVideoCallback
{
private:
...
public:
    ...
    STDMETHODIMP QueryInterface(REFIID riid, void **ppvObject)
    {
        ...
        else if (riid == __uuidof(IDDrawExclModeVideoCallback))
        {
            *ppvObject = static_cast<IDDrawExclModeVideoCallback*>(this);
        }
        else 
        {
