...
//-----------------------------------------------------------------------------
SmartPtr<IGraphBuilder>  g_pGB;          // GraphBuilder
SmartPtr<IMediaControl>  g_pMC;          // Media Control
SmartPtr<IMediaPosition> g_pMP;          // Media Position
SmartPtr<IMediaEvent>    g_pME;          // Media Event
SmartPtr<IBaseFilter>    g_pRenderer;    // our custom renderer
