...
{  
    ...
    if(m_spQuery)
    {
        ...
        if(SUCCEEDED(hr))
        {
            ...
            ListView_SetItemText(m_hQueryList, index, 1, OLE2W(bstrAttr));
            ListView_SetItemText(m_hQueryList, index, 2, OLE2W(bstrOperator));
            ListView_SetItemText(m_hQueryList, index, 3, OLE2W(bstrValue));
        }
    }
