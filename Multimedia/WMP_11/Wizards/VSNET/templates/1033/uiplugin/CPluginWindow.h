...
public:
				   ...
				   LPARAM lParam, BOOL& bHandled)
	{
        ...
        {
[!if HASPROPERTYPAGE]
            TCHAR *szDisplayString = m_pPlugin->m_szPluginText;
[!else]
            TCHAR *szDisplayString = _T("[!output root] Plugin");
[!endif]
            ::FillRect(hDC, &rc, hNewBrush );
            ::DeleteObject( hNewBrush );
            ::DrawText(hDC, szDisplayString, lstrlen(szDisplayString), &rc, DT_SINGLELINE | DT_VCENTER | DT_CENTER);
        }
