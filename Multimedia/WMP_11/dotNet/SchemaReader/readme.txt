...
This sample creates a tool that uses the Windows Media Player object model to retrieve and display information about metadata in the Windows Media Player library or a digital media file. The tool can save the results to a text file. This sample requires Windows Media Player 11.
