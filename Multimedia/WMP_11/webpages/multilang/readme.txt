...
This sample demonstrates how to use the multiple language track feature of the Windows Media format with the Windows Media Player 9 Series or later ActiveX control.
