...
HRESULT DeviceBindTo(
        ...
        __out WCHAR** ppszEndpointDeviceId)   // Device ID. Need to be freed in caller with CoTaskMemoryFree if it is not NULL
{
    HRESULT hResult;
...
//                   specified device.
///////////////////////////////////////////////////////////////////////////////
HRESULT GetInputJack(__in IMMDevice * pDevice, 
