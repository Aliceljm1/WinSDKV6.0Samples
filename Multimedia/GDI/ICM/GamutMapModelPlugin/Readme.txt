...
To install the sample plugin, the plugin .DLL files and XML Profile files must be copied onto a Longhorn machine, and the plugin .DLL file must registered using RegSvr32.exe
