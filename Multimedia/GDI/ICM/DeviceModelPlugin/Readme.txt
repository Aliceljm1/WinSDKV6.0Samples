...
To install the sample plugins, the plugin .DLL file and XML Profile file must be copied onto a Longhorn machine, and the plugin .DLL file must registered using RegSvr32.exe
