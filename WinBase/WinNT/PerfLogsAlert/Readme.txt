What is it?
==========
Before Longhorn, a user had to use tools (e.g., Perfmon, Logman) in order to collect performance data. 
Longhorn introduces a new API, called Performance Logs & Alerts (PLA), which allows you to programmatically collect
