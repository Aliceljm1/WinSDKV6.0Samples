...
bool STDMETHODCALLTYPE DepWriter::OnPrepareBackup(IN IVssWriterComponents*)
{
    return true;
}
...
// This function is called after a requestor calls DoSnapshotSet
bool STDMETHODCALLTYPE DepWriter::OnPostSnapshot(IN IVssWriterComponents*)
{
    return true;
}
...
bool STDMETHODCALLTYPE DepWriter::OnBackupComplete(IN IVssWriterComponents*)
{
	return true;	
}	
...
// of the requestor.
bool STDMETHODCALLTYPE DepWriter::OnBackupShutdown(IN VSS_ID)
{
	return true;
}
...
bool STDMETHODCALLTYPE DepWriter::OnPreRestore(IN IVssWriterComponents *)
{
    return true;
}
...
bool STDMETHODCALLTYPE DepWriter::OnPostRestore(IN IVssWriterComponents*)
{
    return true;
}
