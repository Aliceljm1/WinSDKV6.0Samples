...
If Args.Item(0) = "-register" Then 
	If Args.Count <> 4 AND Args.Count <> 5 Then PrintsUsage
	If Args.Count = 5 Then
		If Args.Item(4) <> "-msdtc" Then PrintsUsage
	End If
...
Sub PrintsUsage
	...
	Wscript.Echo "      CScript.exe " & Wscript.ScriptName & " -register <Provider_Name> <Provider.DLL>  <Provider_Description> [-msdtc]" 
	Wscript.Echo "" 
...
Sub InstallClusterMSDTC
	...
	' Deleting previous MS-DTC instances, if any
