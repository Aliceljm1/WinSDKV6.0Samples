...
:installfromSDKDirs
@if "%PROCESSOR_ARCHITECTURE%" EQU "x86"   (set DLL_DIR=%CMD_DIR%\..\..\..\..\BIN\vsstools)
@if "%PROCESSOR_ARCHITECTURE%" EQU "AMD64" (set DLL_DIR=%CMD_DIR%\..\..\..\..\BIN\x64\vsstools)
@if "%PROCESSOR_ARCHITECTURE%" EQU "IA64"  (set DLL_DIR=%CMD_DIR%\..\..\..\..\BIN\IA64\vsstools)
@set VBS_DIR=%CMD_DIR%
@call :checkfiles
