...
_tmain(void)
{
    ...
    sprintf_s(szEventReconnect,256, TEXT("Global\\sysinf_s-%u-Reconnect"), dwSessionId);
    sprintf_s(szEventDisconnect,256, TEXT("Global\\sysinf_s-%u-Disconnect"), dwSessionId);
