...
--*/
{
   ...
   filter.displayData.description = L"Filter to allow MSN Messenger traffic";
...
--*/
{
   ...
   printf("Retrieving MSN Messenger Application Id\n");
   ...
   printf("MSN Messenger Traffic is now permitted (all other traffic is denied).  Please press any key to exit (this will remove the filters).\n");
