...
Windows Vista
or
Windows XP Professional with Authorization Manager installed,
or
Windows 2000 Server SP4 with Authorization Manager installed
or 
Windows Server 2003
...
7. In the Directory Tab, under application settings, click the create button
   to make an application space.

8. In order to use Integrated Authorization, open the Directory Security Tab
   and under Authentication and Access Control click the Edit button.  Uncheck
   “Enable Anonymous Access” and check the “Integrated Windows Authentication”.
