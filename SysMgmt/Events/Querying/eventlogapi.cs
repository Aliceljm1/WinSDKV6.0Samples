...
#region Querying
    ...
    {
        QueryChannelPath             = 0x1,
        QueryFilePath                = 0x2,
        QueryForwardDirection        = 0x100,
        QueryReverseDirection        = 0x200
    }
    /// <summary>
    /// Event Seek flags to seek to a particular position in event query result
    /// </summary>
    public enum SeekFlags 
    {
        SeekRelativeToFirst         = 1,
        SeekRelativeToLast          = 2,
        SeekRelativeToCurrent       = 3,
        SeekRelativeToBookmark      = 4
    }
    ...
    public partial class Events
    {
        ...
        public static extern IntPtr Query(
            IntPtr session,
        ...
        [DllImport("wevtapi.dll", EntryPoint = "EvtSeek", CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Auto, SetLastError = true)]
        public static extern bool SeekToEvent(
            IntPtr queryHandle,
            Int64 pos,
            IntPtr bookMarkToSet,
            int timeOut,
            [MarshalAs(UnmanagedType.I4)]SeekFlags flags);
    }
