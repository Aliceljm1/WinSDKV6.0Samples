...
InitClasses(void)
{
    ...
    wc.lpszClassName = TEXT("ColorPick");
    ...
    wc.lpszMenuName = NULL;
    wc.lpszClassName = TEXT("FakeMenuDemo");
...
WinMain(HINSTANCE hinst, HINSTANCE hinstPrev, LPSTR pszCmdLine, int nCmdShow)
{
    ...
    hwnd = CreateWindow(
        TEXT("FakeMenuDemo"),           /* Class Name */
        TEXT("Fake Menu Demo - Right-click in window to change color"), /* Title */
