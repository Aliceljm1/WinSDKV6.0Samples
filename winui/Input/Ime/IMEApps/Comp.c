        ...
        case IMN_CHANGECANDIDATE:
...
#ifdef _DEBUG
            {
                ...
                if (dwSize = ImmGetCandidateList(hIMC,0x0,NULL,0))
                {
                    ...
                    StringCchPrintf((LPSTR)szDev,ARRAYSIZE(szDev),"dwCount %d\r\n",lpC->dwCount);
                    OutputDebugString((LPSTR)szDev);
                    StringCchPrintf((LPSTR)szDev,ARRAYSIZE(szDev),"dwSelection %d\r\n",lpC->dwSelection);
                    OutputDebugString((LPSTR)szDev);
                    StringCchPrintf((LPSTR)szDev,ARRAYSIZE(szDev),"dwPageStart %d\r\n",lpC->dwPageStart);
                    OutputDebugString((LPSTR)szDev);
                    StringCchPrintf((LPSTR)szDev,ARRAYSIZE(szDev),"dwPageSize %d\r\n",lpC->dwPageSize);
                    OutputDebugString((LPSTR)szDev);
